...
// 版本資訊(csc 會據此自動產生 Win32 版本資源)→ 防火牆「名稱」、內容>詳細資料 都會看到。
// 「發行者」那行另外靠數位簽章(自簽憑證 小咩/YangMieh),非這裡。
[assembly: AssemblyTitle("CyberPaste")]              // → FileDescription(防火牆「名稱」)
[assembly: AssemblyProduct("CyberPaste")]            // → ProductName
